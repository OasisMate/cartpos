...
- [x] **Trial / billing** — the monetization gate. SHIPPED and ENFORCING
  (Solo 1,999 / Team 3,999 / Business 5,999, 14-day trial, manual payment + claim queue,
  read-only on expiry). Merged to `main`; `BILLING_ENFORCED=true` set in Vercel. Daily sweep
  on Vercel cron since 2026-08-26. Detail in local `docs/BILLING_PLAN.md` (gitignored).
