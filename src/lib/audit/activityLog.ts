...
export const ActivityActions = {
  ...
  // Billing actions. Money and access changes must always be traceable to a
  // person: who set that price, who verified that payment, who closed that shop.
  UPDATE_PLAN_PRICE: 'UPDATE_PLAN_PRICE',
  UPDATE_SUBSCRIPTION_PRICE: 'UPDATE_SUBSCRIPTION_PRICE',
  CHANGE_PLAN: 'CHANGE_PLAN',
  RECORD_PAYMENT: 'RECORD_PAYMENT',
  SUBMIT_PAYMENT_CLAIM: 'SUBMIT_PAYMENT_CLAIM',
  ...
  TOGGLE_SHOP_ACTIVE: 'TOGGLE_SHOP_ACTIVE',
  SWAP_ACTIVE_SHOP: 'SWAP_ACTIVE_SHOP',
  ...
  GRANT_FREE_ACCESS: 'GRANT_FREE_ACCESS',
  REVOKE_FREE_ACCESS: 'REVOKE_FREE_ACCESS',
  ...
  CREATE_PURCHASE_LIST: 'CREATE_PURCHASE_LIST',
  SEND_PURCHASE_LIST: 'SEND_PURCHASE_LIST',
  RECEIVE_PURCHASE_LIST: 'RECEIVE_PURCHASE_LIST',
  DELETE_PURCHASE_LIST: 'DELETE_PURCHASE_LIST',
