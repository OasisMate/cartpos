    ...
    <Modal open={open} onClose={onClose} title="Add products from catalog" size="xl">
      <div className="space-y-3">
        <div className="text-sm text-[hsl(var(--muted-foreground))]">
          Tick what you stock and set your price. Prices shown are typical retail, so change any
          that differ. You can add more later, and cost prices any time after that.
        </div>
        ...
        <div className="flex items-center justify-between gap-3 pt-2 border-t">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleAdd} disabled={picked.size === 0 || saving}>
