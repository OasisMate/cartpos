...
export default function Signup() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col lg:flex-row overflow-y-auto" dir="ltr">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute top-1/2 right-0 -translate-y-1/2 flex items-center justify-center pr-2 text-gray-500 hover:text-gray-700 focus:outline-none"
                      disabled={loading}
                    >
